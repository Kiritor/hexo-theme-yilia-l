...
/** -------------- END UgFunctions class ---------------------*/
	...
	function ugCheckForErrors(galleryID, type){
		...
		errorMessage = "<div style='font-size:16px;color:#BC0C06;max-width:100%;border:1px solid red;padding:10px;'>" + errorMessage + "</div>"
...
var wwwdith = $(window).width();
var g_options = {
			gallery_width:wwwdith,							//gallery width
...
function UGBullets(){
	...
	var g_options = {
		...
		bullets_space_between:0			//set the space between bullets. If -1 then will be set default space from the skins
	}
